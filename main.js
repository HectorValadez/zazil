...
$(document).ready(function(){
  ...
  particlesJS("particles-js", {
    particles: {
      ...
      color: {
        value: ["#008C34", "#3b48a4", "#5ebaa5","#FCE181"],
      },
      shape: {
        type: "polygon",
      },
  ...
  function init() {
    ...
    l1.load("IMG_20191026_121604167.jpg", function(img) {
      slide.setImage(img);
    })
    root.scene.add(slide);
  
    slide2 = new Slide(width, height, 'in');
    l2 = new THREE.ImageLoader();
    l2.setCrossOrigin('Anonymous');
    l2.load("IMG_20210505_231515.jpg", function(img) {
      slide2.setImage(img);
    })
